	...
	return (
		<section>
			<article className="section-heading">
				<h2>Search for Nursing Homes Near You</h2>
				<p>
					We have information on over 6000 Nursing Homes in Finland. Find the
					nearest care home in your area by using the search box below. Type in
					your address, or city or your postal code in the search box.
				</p>
			</article>
			<form
